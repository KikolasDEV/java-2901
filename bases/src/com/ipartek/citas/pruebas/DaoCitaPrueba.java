package com.ipartek.citas.pruebas;

import java.time.LocalDateTime;

import com.ipartek.citas.accesodatos.DaoCita;
import com.ipartek.citas.accesodatos.DaoCitaArrayList;
...
public class DaoCitaPrueba {
	public static void main(String[] args) {
		...
		dao.modificar(new Cita(2L, "MODIFICADA", LocalDateTime.of(2025, 9, 25, 8, 15), LocalDateTime.of(2025, 9, 25, 13, 45)));
